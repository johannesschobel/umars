  ...
  <body>
    ...
    <div class="container">
	  ...
	  <div class="row hidden-print">
		...
		<div class="col-md-6">
		  <a class="btn btn-lg btn-success center-block" href="/projects/<?php echo($sProject); ?>" role="button"><span class="glyphicon glyphicon-refresh"></span> Fragebogen erneut starten</a>
		</div>
      </div>
